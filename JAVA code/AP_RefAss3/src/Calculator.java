...
public class Calculator extends JFrame implements ActionListener{
	...
	Calculator(){
		calc = new JFrame("Basic Calculator");
...
//		calc.setSize(600, 600);		
	...
	public static void main(String args[]){
		System.out.println("This is basic calculator supports one operation at once, enter key can also be used to get the results.");
